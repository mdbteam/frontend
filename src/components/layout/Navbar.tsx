      ...
      {isOpen && (
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <NavLink to="/" className={({isActive}) => `block px-3 py-2 rounded-md text-base font-medium ${isActive ? 'bg-cyan-500 text-white' : 'text-gray-700 hover:bg-gray-50'}`}>
              Inicio
            </NavLink>
            <NavLink to="/prestadores" className={({isActive}) => `block px-3 py-2 rounded-md text-base font-medium ${isActive ? 'bg-cyan-500 text-white' : 'text-gray-700 hover:bg-gray-50'}`}>
              Buscar Prestadores
            </NavLink>
          </div>
